...
import {
    ...
    INVALIDATE_PRODUCTO_LOGUEADO,
    REQUEST_PRODUCTO_LOGUEADO,
    ERROR_PRODUCTO_LOGUEADO,
    RECEIVE_PRODUCTO_LOGUEADO,
    RESET_PRODUCTO_LOGUEADO,
...
function update(state = {
    isFetchingProductoLogueado: false,
    isUpdating: false,
